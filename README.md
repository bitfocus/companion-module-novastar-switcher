# Novastar Switcher Companion Module

A Companion module for controlling Novastar Switcher devices.  
...
- Connect to Novastar Switcher devices
...
- Configure your Novastar Switcher device IP in the module settings.
