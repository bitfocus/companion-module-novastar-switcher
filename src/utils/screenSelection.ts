...
/** Identify a screen by screenIdObj.id + type; aligned with preset screens entries and self.screens */
...
/** Update local selected state from screens involved in a preset */
